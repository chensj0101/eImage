 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/e/eBusinessInfoIndex")
public class EBusinessInfoIndexController extends BaseController {
	 ...
	 * 保存企业工商信息
	 */
	@RequiresPermissions("e:eBusinessInfoIndex:edit")
